...
using System.Linq;
using EventLite.WebForms.Models;

namespace EventLite.WebForms.Services
{
    public static class EventRepository
    {
        ...
        public static IEnumerable<Event> GetAll() => _events ?? Enumerable.Empty<Event>();

        public static Event GetById(int id) => GetAll().FirstOrDefault(e => e.Id == id);
    }
}